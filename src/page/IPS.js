...
import bgips from "../img/pretelan/social-01.svg";
import daftarips from "../img/pretelan/daftar.svg";
import bukpanips from "../img/pretelan/bupan.svg";
...
<img className="background-ips" src={bgips} alt=""/>

<div className="buttons-ips">
  <img className="daftar-ips" src={daftarips} alt=""   onClick={() => window.open(register, '_blank')}/>
  <img className="bupan-ips" src={bukpanips} alt="" onClick={handleShowModal2} />
</div>
